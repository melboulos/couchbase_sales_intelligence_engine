...
def validate_score(score):
    ...
    if score < 0 or score > 100:
        ...
        raise ValueError(
            ...
            "Seller value score must be 0-100"
...
def validate_discovery_progression(result):
    ...
    if not isinstance(
        ...
        raise ValueError(
            ...
            "discovery_progression must be list"
    ...
    for phase in progression:
        ...
        if not isinstance(
            ...
            raise ValueError(
                ...
                "discovery_progression entries must be objects"
        ...
        for field in required:
            ...
            if field not in phase:
                ...
                raise ValueError(
                    ...
                    f"Missing discovery field: {field}"
        ...
        if not isinstance(
            ...
            raise ValueError(
                ...
                "Discovery questions must be list"
...
def validate_evidence_quality(result):
    ...
    if violations:
        ...
        raise ValueError(
            ...
            f"Invalid technical evidence: {violations}"
...
def validate_llm_value(result):
    ...
    if violations:
        ...
        raise ValueError(
            ...
            f"Low-value generic output: {violations}"
...
def validate_llm_output(
    ...
    if violations:
        ...
        raise ValueError(
            ...
            f"Hallucination detected: {violations}"
    ...
    validate_discovery_progression(
...
def validate_account(row):
    ...
    gate_result = deterministic_gate(
